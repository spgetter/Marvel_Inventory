...
import hero_image from '../../assets/images/toppng.com-download-marvel-super-heroes-1153x1004.png';
import brand_image from '../../assets/images/icons/281788_ironman_super_hero_iron_stark_icon.png';
                ...
                <div className={classes.navbar_container}>
                    <h1 className={ `${classes.logo}` }>
                        <a href="#" className={ `${classes.logo_a} ${classes.logo_navigation}` } >
                            <img className={`${classes.logo_img}`} src={`${brand_image}`} alt={'Brand Logo'} />
                        </a>
                    </h1>
                    <ul className={`${classes.navigation} ${classes.logo_navigation}`}>
                        ...
                        <Suspense fallback={'loading...'}>
                            <AuthCheck fallback={
                                ...
                                <li>
                                    <Link to="/cardcollection" className={classes.nav_a}>Card Collection</Link>
                                </li>
                                <li>
